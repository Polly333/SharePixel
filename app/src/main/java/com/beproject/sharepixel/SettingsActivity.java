...
public class SettingsActivity extends AppCompatActivity {
                ...
                try {
                    ...
                    if(!jsonObject.getBoolean("error")){
                        ...
                        if(!emailString.isEmpty()) {
                            ...
                            SharedPreferenceManager.getInstance(getApplicationContext()).updateEmail(emailString);
                        }
    ...
    private void getNewProfileImage(){
        ...
        startActivityForResult(intent,CHANGE_PROFILE_IMAGE); //can cause ISSUE
                    ...
                    try {
                        ...
                        if(!jsonObject.getBoolean("error")){
                            ...
                            if(!imageString.isEmpty()) {
                                ...
                                SharedPreferenceManager.getInstance(getApplicationContext()).updateProfileImage(imageString);
